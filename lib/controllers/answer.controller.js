...
exports.updateAnswer = exports.getAnswersByParticipant = exports.getAnswers = exports.getAnswer = exports.deleteAnswer = exports.createAnswers = exports.createAnswer = void 0;
...
const getAnswersByParticipant = async (req, res) => {
  try {
    const data = await _models.default.Answer.findAll({
      ...
      attributes: [[_models.sequelize.fn('date', _models.sequelize.col('answer_createdAt')), 'answer_createdAt']],
      where: {
        participante_id: req.params.id
      },
      group: [[_models.sequelize.fn('date', _models.sequelize.col('answer_createdAt')), 'answer_createdAt']]
    });
    res.status(200).json({
      data,
      mensaje: 'Operación realizada con exito',
