...
exports.updateParticipante = exports.getParticipantesByUser = exports.getParticipantes = exports.getParticipante = exports.deleteParticipante = exports.createParticipante = void 0;
...
const getParticipantesByUser = async (req, res) => {
  try {
    const data = await _models.default.Participante.findAll({
      attributes: {
        exclude: ["participante_age"]
...
exports.getParticipantesByUser = getParticipantesByUser;
