...
exports.updateInstitutionalizationHistory = exports.patchInstitutionalizationHistory = exports.getInstitutionalizationHistory = exports.getInstitutionalizationHistories = exports.deleteInstitutionalizationHistory = exports.createInstitutionalizationHistory = void 0;
...
const patchInstitutionalizationHistory = async (req, res) => {
  try {
    const institutionalization_history = await _models.default.InstitutionalizationHistory.update(req.body, {
      where: {
        history_id: req.params.id
...
exports.patchInstitutionalizationHistory = patchInstitutionalizationHistory;
...
//# sourceMappingURL=institucionalizationhistory.controller.js.map